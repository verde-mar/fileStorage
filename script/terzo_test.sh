...
for (( i=1; i<=15; i++ )); do
    ./cl -f socket -t 0 -D ./flushed -W ./test_directory/prova.txt -D ./flushed -w ./test_directory/ -l ./test_directory/prova10.txt -u ./test_directory/prova10.txt &
    ./cl -f socket -t 0 -d ./read -r ./test_directory/prova4.txt -D ./flushed -l ./test_directory/prova2.txt -u ./test_directory/prova2.txt -c ./test_directory/prova8.txt &
