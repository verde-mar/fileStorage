...
for (( i=1; i<=15; i++ )); do
    ...
    ./cl -f socket -t 0 -d ./read -r ./test_dir1/prova4.txt -D ./flushed -l ./test_dir1/prova2.txt -u ./test_dir1/prova2.txt -c ./test_dir1/prova8.txt -W ./test_dir2/prova12.txt &
    ./cl -f socket -t 0 -D ./flushed -W ./test_dir1/prova3.txt -D ./flushed -W ./test_dir1/prova7.txt -l ./test_dir1/prova6.txt -u ./test_dir1/prova6.txt -d ./read -R 0 &
